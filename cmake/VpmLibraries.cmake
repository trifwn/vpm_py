function(define_vpm_targets)
    ...
    set(TEST_EXE_SRC
        ${SRC_TEST}/test.f90
        ${SRC_TEST}/test_problems/problems.f90
    )
    ...
    target_link_libraries(yaps PRIVATE mpi_matrices pmlib pmproject types console_io file_io h5fortran::h5fortran)
    ...
    add_dependencies(operators_api arrays types operators_serial) # Ensure proper dependency resolution
    ...
    target_link_libraries(vpm_py_api 
        PUBLIC 
            vpm_lib arrays yaps pmlib pmproject parvar pmgrid  
            vpm_size vpm_vars vpm_interpolate vpm_gcalc vpm_mpi vpm_remesh vpm_functions
            console_io file_io types constants 
