...
Program test_pm
   ...
   do i = 1, max_iter
      ...
      call vpm_solve_velocity_deformation(i, XPR, QPR, UPR, GPR, NVR_ext, NVR_size, neq, RHS_ptr, vel_ptr)
      !---
      ...
      call vpm_define_problem(i, XPR, QPR, NVR_ext, NVR_size, neq)
      tab_level = 0
      !--- END VPM DEFINE
