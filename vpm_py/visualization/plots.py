...
particle_vorticity_x_plot_option = ResultPlot('particle', 'charge', 'x')
particle_vorticity_y_plot_option = ResultPlot('particle', 'charge', 'y')
particle_vorticity_z_plot_option = ResultPlot('particle', 'charge', 'z')
...
particle_vorticity_magnitude_plot_option = ResultPlot('particle', 'charge', 'magnitude')
...
mesh_vorticity_x_plot_option = ResultPlot('mesh', 'charge', 'x')
mesh_vorticity_y_plot_option = ResultPlot('mesh', 'charge', 'y')
mesh_vorticity_z_plot_option = ResultPlot('mesh', 'charge', 'z')
...
mesh_vorticity_magnitude_plot_option = ResultPlot('mesh', 'charge', 'magnitude')
